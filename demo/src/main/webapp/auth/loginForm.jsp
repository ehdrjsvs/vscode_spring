  ...
  <body>
    ...
    <div class="container">
      <form id="f_login" action="/auth2/login.pj3" method="post">
        ...
        <a
          href="https://kauth.kakao.com/oauth/authorize?client_id=896f11cd1644ef2adbd2eff3c8f7fe3a&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code"
        > <img
		src="/images/ko/kakao_login_medium_narrow.png"
		alt="카카오로그인"
	/></a>
         </a>
        <button
